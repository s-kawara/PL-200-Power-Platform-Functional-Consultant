...
13. Select **Knowledge Assessments** for Table name.

14. Click on **Show advanced options.**

16. Select the **Filter rows** field and type the following:
...
23. If required, select your environment. Then select **Knowledge Assessments**
    for **Table name**. Depending on your UI, you will then either see **Row ID** or **Record Identifier.** Select this field.
